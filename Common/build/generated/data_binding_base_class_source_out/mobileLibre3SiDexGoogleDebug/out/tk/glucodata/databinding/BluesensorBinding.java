...
public final class BluesensorBinding implements ViewBinding {
  ...
  @NonNull
  public final CheckBox alarmclock;
  ...
  private BluesensorBinding(@NonNull measuredgrid rootView, @NonNull CheckBox alarmclock,
      @NonNull CheckBox android13, @NonNull Button background, @NonNull TextView bluestate,
      @NonNull Button close, @NonNull TextView confail, @NonNull TextView connection,
      @NonNull TextView constatus, @NonNull TextView consuccess, @NonNull TextView deviceaddress,
      @NonNull Button finish, @NonNull Button forget, @NonNull TextView glucosefailure,
      @NonNull TextView glucoseinfo, @NonNull TextView glucosesuccess, @NonNull measuredgrid grid,
      @NonNull Button help, @NonNull Button info, @NonNull TextView keyfailure,
      @NonNull TextView keyinfo, @NonNull TextView keysuccess, @NonNull Button locationpermission,
      @NonNull CheckBox priority, @NonNull Button resetbutton, @NonNull TextView rssi,
      @NonNull TextView scan, @NonNull Spinner sensors, @NonNull TextView stage,
      @NonNull CheckBox streamhistory, @NonNull TextView streaming, @NonNull TextView textView2,
      @NonNull TextView textView3, @NonNull TextView textView4, @NonNull CheckBox usebluetooth) {
  ...
  public static BluesensorBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.alarmclock;
      CheckBox alarmclock = ViewBindings.findChildViewById(rootView, id);
      if (alarmclock == null) {
        break missingId;
      }
      ...
      return new BluesensorBinding((measuredgrid) rootView, alarmclock, android13, background,
          bluestate, close, confail, connection, constatus, consuccess, deviceaddress, finish,
          forget, glucosefailure, glucoseinfo, glucosesuccess, grid, help, info, keyfailure,
          keyinfo, keysuccess, locationpermission, priority, resetbutton, rssi, scan, sensors,
          stage, streamhistory, streaming, textView2, textView3, textView4, usebluetooth);
    }
