...
static bool	getpathworks() {
	// Avoid executing helper scripts from app data dir (SELinux denies execute_no_trans)
	return false;
	}
...
void usepath() {
	globalsetpathworks=false; // never try executing from app data PATH on modern Android
